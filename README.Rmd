...
The demo script (`man/demo_decay.R`) provides a command-line exploration of how different decay parameters affect group consensus in SJS simulations.
...
- **Decay Parameter (0.1-5.0):** Determines how quickly influence decreases with distance between positions
  ...
  - Higher values (e.g., 5.0): Less influence from distant positions, slower change
